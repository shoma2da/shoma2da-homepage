...
- [x] `Header.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `Hero.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `About.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `Biography.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `Favorites.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `Links.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
- [x] `Footer.tsx` - ハードコードされたカラーコードをTailwindのCSS変数に置き換え
